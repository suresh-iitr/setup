...
.. code-block:: console
   ...
   docker run it --name fluentbit -p 24224:24224 --net opensearch -v AlertVolume:/AlertVolume -v /var/log/:/var/log/ -e OPENSEARCH_HOST="opensearch" -e SRC_HOST=$(hostname -I | cut -f1 -d' ') 19914039/fluentbit:aarch64


If you want to get exit of the container then
...
the restart the container after this if you want to you again.
